...
#SBATCH --time=00:20:00     # set time limit to 1 minute
...
mpic++ -std=c++17 -O3 -Wall -pedantic -march=native -ffast-math main1.cpp -o solverMPI
...
mpi_mode="1D"
filenames="benchmark_125 benchmark_250 benchmark_1000 benchmark_2000"
